...
#define REFLEX_AUTO_NULL_EX(MODULE, NS, TYPE, IMPL, VAR, ORDER) namespace NS { Reflex::Detail::Module::Member <IMPL> VAR(MODULE, ORDER); } NS::TYPE & NS::TYPE::null = NS::VAR
#define REFLEX_AUTO_NULL(MODULE, NS, TYPE) REFLEX_AUTO_NULL_EX(MODULE, NS, TYPE, TYPE, g##_null_##TYPE, 0)
