...
struct NullEnumParamDesc : EnumParamDesc
{
	NullEnumParamDesc()
	{
		type = kTypeEnum;
...
Reflex::Detail::Module::Member <NullEnumParamDesc> g_null_param_info(module);

REFLEX_END_INTERNAL

Reflex::Bootstrap::EnumParamDesc & Reflex::Bootstrap::EnumParamDesc::null = Reflex::Bootstrap::g_null_param_info;
...
Reflex::Bootstrap::AudioPlugin::Parameters::Parameters(AudioPlugin & instance)
	: Streamable(instance.session, K32("parameters"), 1)
	, instance(instance)
	, paramdefs(global->QueryProperty<ParamDefs>(K32("bootstrap.paramdefs")))
...
Reflex::Bootstrap::AudioPlugin::AudioPlugin(UInt32 magic, System::AudioPlugin & system)
	: App(magic)
	, instance(system)
	, m_parameters(*this)
...
void Reflex::Bootstrap::Detail::RestoreStandaloneAudioApp(Global & global, System::AudioPlugin & audioplugin)
{
	...
	if (auto stream = Data::GetBinary(global.prefs, K32("Bootstrap:AudioMidiSettings")))
	{
...
void Reflex::Bootstrap::Detail::StoreStandaloneAudioApp(Global & global, System::AudioPlugin & audioplugin)
{
	...
	Data::SetBinary(global.prefs, K32("Bootstrap:AudioMidiSettings"), stream);
}
