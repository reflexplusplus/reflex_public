...
Reflex::TRef <Reflex::IDE::ResourceGroup> Reflex::Bootstrap::CreateScriptObject(const WString::View & path, const ArrayView <ConstTRef<VM::Module>> & modules, const ArrayView < Tuple <VM::StaticString, TRef<Object>> > & externals, const Function <void(VM::Context & context, GLX::Object & object)> & on_create)
{
	...
	struct State : public Object
	{
		...
		Array < Tuple < VM::StaticString, TRef<Object> > > externals;
