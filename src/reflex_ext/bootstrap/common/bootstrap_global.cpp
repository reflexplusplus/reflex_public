...
constexpr UInt32 kIDE = K32("Bootstrap:IDE");
...
{
	if (address == MakeAddress<Data::CStringProperty>(K32("DeepLinkUrl")))
	{
...
#ifndef REFLEX_BOOTSTRAP_TYPE_CONSOLE_APP
		if (projectdir) lock.Attach(New<IDE::ProxyPath>(K32("res"), resources_subdomain, Join(projectdir, L"resources", System::kPathDelimiter)));
#endif
	}
