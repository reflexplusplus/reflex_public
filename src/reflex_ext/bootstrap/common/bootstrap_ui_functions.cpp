...
ConstTRef <GLX::StyleSheet> ApplyStyleSheet(GLX::Object & view, const WString::View & path, ArrayView <Key32> substyle, FunctionPointer <TRef<Data::PropertySet>(GLX::Object & view)> create_options)
{
...
void Reflex::Bootstrap::Detail::SetStyle(GLX::Object & view, const WString::View & path, const ArrayView <Key32> & substyle, FunctionPointer <TRef<Data::PropertySet>(GLX::Object & view)> create_options)
{
