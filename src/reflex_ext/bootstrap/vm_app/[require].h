...
struct VmViewWrapper : public View
{
	...
	static TRef <VmViewWrapper> Create(App & app, const WString::View & path, const ArrayView < Tuple <VM::StaticString, TRef<Reflex::Object>> > & externals, UInt8 flags = VM::kContextFlagUi, const ArrayView <ConstTRef<VM::Module>> & modules = {});
...
{
	VmViewWrapperImpl(App & app, const WString::View & path, const ArrayView < Tuple <VM::StaticString, TRef<Reflex::Object>> > & externals, UInt8 flags, const ArrayView <ConstTRef<VM::Module>> & modules)
		: VmViewWrapper(app),
...
Reflex::TRef <Reflex::Bootstrap::Detail::VmViewWrapper> Reflex::Bootstrap::Detail::VmViewWrapper::Create(App & app, const WString::View & path, const ArrayView < Tuple <VM::StaticString, TRef<Reflex::Object>> > & externals, UInt8 context_flags, const ArrayView <ConstTRef<VM::Module>> & modules)
{
