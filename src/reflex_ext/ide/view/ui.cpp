...
struct UI::Performance : public Panel
{
	...
	InfoItem m_object_count, m_style_count, m_font_count, m_layer_count, m_animation_count, m_active_animation_count, m_renderer_count, m_texture_renderer_count, m_state_renderer_count, m_count, m_clock_count, m_update_count, m_rebuild_count, m_accommodate_count, m_align_count, m_responsive_align_count;
	...
	m_responsive_align_count(L"Responsive Align Count")
{
	...
	m_window_infos[GLX::WindowClient::kDebugCounterClock] = { &m_clock_count, 0 };
