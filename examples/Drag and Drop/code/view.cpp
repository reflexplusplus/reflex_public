			...
			if (GLX::ExceedsDragThreshold(GLX::GetDelta(e)))
			{
				...
				GLX::SetEventDelegate(dst_row, "drag_drop_handler", [this, dst_row](GLX::Object & src, GLX::Event & e)
				{
					...
					if (auto drag_src = GLX::QueryDragDropData<GLX::Object>(e))
					{
						...
						GLX::Enter(*drag_src, GLX::kEnterAnimationFade | GLX::kEnterAnimationSize | GLX::kEnterNoClip);
				...
				SetAbstractProperty(*this, "global_drag_end_listener", GLX::CreateDragDropEndListener([this, src_row, &src]()
				{
					if (!Data::GetBool(*this, "dropped"))
					{
						...
						GLX::Enter(src, GLX::kEnterAnimationFade | GLX::kEnterAnimationSize | GLX::kEnterNoClip);
					}
				...
				GLX::Exit(src, true, GLX::kEnterAnimationFade | GLX::kEnterAnimationSize | GLX::kEnterNoClip);
			}
