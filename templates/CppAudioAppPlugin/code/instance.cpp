	...
	public Bootstrap::Streamable
{
	...
	InstanceImpl(System::AudioPlugin & audioplugin)
		: Instance(MakeKey32("_PRODUCT-NAME-SYMBOL_"), audioplugin)	//first parameter is 4 byte header for the file format
		, Bootstrap::Streamable(session, MakeKey32("custom"), kChunkVersion)
